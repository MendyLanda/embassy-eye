# Hungary Embassy Appointment Scraper

Automated appointment monitoring and booking system for the Hungarian Embassy appointment scheduling (konzinfobooking.mfa.gov.hu). This tool continuously checks for available appointment slots and sends notifications via Telegram when slots become available.
...
**Using Python:**
```bash
python -m embassy_eye.scrapers.hungary.runner
# or
python fill_form.py hungary
# or
./run_script.sh
```
